...
public static class Await
{
    public static Task Tasks(
        ...
        bool continueOnCapturedContext = true)
            => AwaitWithExceptionHandling([], tasksWithoutReturnValue, continueOnCapturedContext, exceptionOption);
    ...
    private static async Task AwaitWithExceptionHandling(IEnumerable<Task> tasks, IEnumerable<Task>? moreTasks, bool continueOnCapturedContext, ExceptionOption exceptionOption)
    {
        if (moreTasks != null)
        {
